...
public class Configurator {
    ...
    public void loadProps() {
        try {
            ...
            props.load(new FileInputStream("/home/testing/testingtomcat/webapps/FGRPortal/WEB-INF/classes/getQueries"));
            //props.load(new FileInputStream("E:/EclipseJava8/FGRPortal/src/getQueries"));
